    ...
    return (
        <div className="bg-[#F3F3F3] pt-10  pb-10" >
            <div className="container mx-auto  px-8">
               ...
               <SwipeSlider id={"business"} title={"What are the benefit to your business"} data={benefits} settings={{ margin: "" , width: "md:w-96 w-4/5" , bg: 'bg-[#EAE9E9]' , height: "md:h-96 h-4/5" }}/>
               <div className="mt-10">
